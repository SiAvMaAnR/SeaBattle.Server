...
class Game implements IGame {
  ...
  public shoot(socketId: string, coordinate: Coordinate): boolean {
    ...
    const isCorrect =
      myPlayer.enemyField.getCell(coordinate.y, coordinate.x) == Cell.Empty;
    ...
    const isHit =
      enemyPlayer.myField.getCell(coordinate.y, coordinate.x) == Cell.Exists;
    ...
    isHit ? myPlayer.statistic.addHits() : myPlayer.statistic.addMisses();
